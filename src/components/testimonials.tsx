  ...
  return (
    <div className="text-center why-mercan p-8">
      ...
      <div className="confidence border my-[100px] flex justify-between">
        ...
        <div className="confidence-image w-full md:w-1/2">
          <Image
            src="/prado.png"
            alt="Prado car"
            width={600}
            height={600}
            className="items-center absolute right-0 md:right-40 "
          />
          <Image
            src="/BMW.png"
            alt="BMW car"
            width={600}
            height={600}
            className="items-center hidden md:block relative right-40 top-50"
          />
        </div>
      </div>
      ...
      <div className="flex justify-center items-center mt-4 md:mr-[120px]">
        <Image
          src="/icons/underline.svg"
          alt="Mercan underline"
          width={316}
      ...
      <div className="flex items-center mt-8">
        <div className="w-[100px] h-[100px] md:w-[200px] md:mb-[200px] md:h-[19px]">
          <Image
            src="/quotation.svg"
        ...
        <p className="text-gray-700 items-center w-2/3 text-2xl md:text-4xl p-7">
